...
export default function Card({ name, variant, link }: CardProps) {
    ...
    const variantClass = {
        ...
        bookCard: "transition transform duration-200 ease-in-out cursor-pointer hover:scale-105 m-1 mt-3 w-26 border-0 border-black bg-white h-35 md:w-60 md:h-75 md:m-3 rounded-md block hover:shadow-xl",
        videoCard: "transition transform duration-200 ease-in-out cursor-pointer hover:scale-105 m-3 w-55 h-35 md:w-80 md:h-50 md:m-3 rounded-md block hover:shadow-2xl shadow-black/80",
    };
