  ...
  return (
    <div className="max-w-5xl mx-auto mt-15 px-6">
      <div className="items-center">
        <h1 className="text-4xl font-bold">Videogiochi</h1>
        <p className="mt-3 ml-3 mr-15 text-justify max-w-sm md:max-w-xl text-xl">
          I videogiochi sono il mio passatempo preferito fin da piccolo. Adoro i
          titoli di (quasi) ogni genere ma con particolare interesse verso
          quelli puzzle e gameplay interessanti e avvincenti.
        </p>
        ...
        <div className="md:mr-45 mt-25 flex flex-col items-end">
          <h1 className="text-4xl font-bold text-right">Scrittura</h1>
          <p className="mr-3 mt-3 ml-15 text-justify max-w-sm md:max-w-xl text-xl">
            I videogiochi sono il mio passatempo preferito fin da piccolo. Adoro
            i titoli di (quasi) ogni genere ma con particolare interesse verso
            quelli puzzle e gameplay interessanti e avvincenti.
          </p>
        ...
        <div className="flex flex-wrap md:gap-3 items-start justify-center md:justify-start mb-15">
          {video.map((c, i) => (
